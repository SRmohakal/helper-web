...
const CourseDetails = () => {
  ...
  //need to update this section for backend
  ...
  //this is for buying process
  //need to add this function for backend
  const enrollCourse = async ()=> {
    try{
      if(!userData){
        return toast.warn('Loin to Enroll')
      }
  ...
  //need to add this for buying process 
    useEffect(()=> {
    ...
    px-8 md:pt-30 pt-20 text-left'>
      ...
      {/*left column */}
        ...
        {/* review and ratings */}
            ...
            {/* need to update this p tag for backend */}
